...
class Ui_ConfigureDialog(object):
    def setupUi(self, ConfigureDialog):
        ...
        self.formLayout.setWidget(6, QtGui.QFormLayout.LabelRole, self.label5)
        self.lineEdit1 = QtGui.QLineEdit(self.configGroupBox)
        self.lineEdit1.setObjectName("lineEdit1")
        self.formLayout.setWidget(6, QtGui.QFormLayout.FieldRole, self.lineEdit1)
        self.label6 = QtGui.QLabel(self.configGroupBox)
        self.label6.setObjectName("label6")
        self.formLayout.setWidget(7, QtGui.QFormLayout.LabelRole, self.label6)
        self.lineEdit2 = QtGui.QLineEdit(self.configGroupBox)
        self.lineEdit2.setObjectName("lineEdit2")
        self.formLayout.setWidget(7, QtGui.QFormLayout.FieldRole, self.lineEdit2)
        ...
        self.formLayout.setWidget(8, QtGui.QFormLayout.LabelRole, self.label1)
        ...
        ConfigureDialog.setTabOrder(self.lineEdit1, self.comboBox_in_unit)
        ConfigureDialog.setTabOrder(self.lineEdit2, self.comboBox_in_unit)
    ...
    def retranslateUi(self, ConfigureDialog):
        ...
        self.label5.setText(QtGui.QApplication.translate("ConfigureDialog", "Subject Height (m):", None, QtGui.QApplication.UnicodeUTF8))
        self.label6.setText(QtGui.QApplication.translate("ConfigureDialog", "Subject Mass (kg):", None, QtGui.QApplication.UnicodeUTF8))
