...
from mapclientplugins.gait2392wrapmusclestep.configuredialog import ConfigureDialog
from mapclientplugins.gait2392wrapmusclestep.gait2392musclecusthmf import gait2392MuscleCustomiser
...
class FieldworkGait2392MuscleHMFStep(WorkflowStepMountPoint):
    ...
    def __init__(self, location):
        super(FieldworkGait2392MuscleHMFStep, self).__init__('Gait2392 Muscle HMF', location)
